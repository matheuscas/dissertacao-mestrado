...
Um dos trabalhos encontrados na literatura que realizam a seleção de características, e posteriormente, controem as regras para um sistema fuzzy usando o algoritmo de Wang-Mendel, é o trabalho de \citeonline{cintra2008fuzzy}. Os autores compararam o desempenho de sua proposta com algoritmos clássicos de seleção de características, como CFS \cite{hall1999correlation} e o c4.5 \cite{quinlan2014c4}. 
...
\todo[inline]{mgpires: Matheus, insira esta referência: J. R. Quinlan. C4.5 Programs for Machine Learning. Morgan
Kaufmann, CA, 1988. para o c4.5}
