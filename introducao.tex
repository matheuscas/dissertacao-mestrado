...
Considerando as dificuldades apresentadas que são enfrentadas pelos usuários e empresas e dada a importância das opiniões na vida das pessoas, essa pesquisa tem como objetivo desenvolver e avaliar uma metodologia de classificação de sentimento geral de opiniões em documentos, aplicando um sistema fuzzy automatizado de mineração de opinião associado à extração e seleção de características destes documentos. 
