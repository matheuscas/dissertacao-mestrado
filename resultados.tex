...
\todo[inline]{mgpires: Para mim, o próximo parágrafo está redundante com o anterior. Sugestão: delete!}
\todo[inline]{matheus: foi tarde. :D}
...
\todo[inline]{mgpires: Sugestão de título para esta seção: Avaliação do cenário com 3 conjuntos fuzzy}
...
\todo[inline]{mgpires: Sugestão para o título da seção: Avaliação do cenário com 2 conjuntos fuzzy}
