...
% REGRAS DA AMAZON EM EPINIONS

%{{{{{{{{{{{{{{{RESULTS - FOLD 0 }}}}}}}}}}}}}}}}
%=== Confusion Matrix ===
%a         b        <-- class as
%181 (TP)   19 (FN)      |a = positive (200)
%105 (FP)    95 (TN)      |b = negative (200)
%========================
%Accuracy:  69.0 %
%TPR:  90.5 %
%TNR:  47.5 %
...
%TNR:  47.0 %
%
%---------------- 10-FOLD GENERAL RESULTS ----------------
% ---> Avg Precision:  63.0885594758 %
%Standard Deviation:  0.153877029356 %
% ---> Avg Recall:  90.5 %
%Standard Deviation:  1.11022302463e-14 %
% ---> Avg Accuracy:  68.775 %
%Standard Deviation:  0.175 %
% ---> Avg F1:  74.3480690214 %
%Standard Deviation:  0.106866593171 %
%---> Avg TPR:  90.5 %
%Standard Deviation:  1.11022302463e-14 %
%---> Avg TNR:  47.05 %
%Standard Deviation:  0.35 %
%array([[ 69.  ,  68.5 ,  68.75,  68.5 ,  69.  ,  68.75,  68.75,  69.  ,
%         68.75,  68.75]])


%REGRAS DE FILMES NA EPINIONS - O.O

%{{{{{{{{{{{{{{{RESULTS - FOLD 0 }}}}}}}}}}}}}}}}
%=== Confusion Matrix ===
%a         b        <-- class as
%173 (TP)   27 (FN)      |a = positive (200)
%77 (FP)    123 (TN)      |b = negative (200)
%========================
%Accuracy:  74.0 %
%TPR:  86.5 %
%TNR:  61.5 %
...
%=== Confusion Matrix ===
%a         b        <-- class as
%168 (TP)   32 (FN)      |a = positive (200)
%74 (FP)    126 (TN)      |b = negative (200)
%========================
%Accuracy:  73.5 %
%TPR:  84.0 %
%TNR:  63.0 %
...
%=== Confusion Matrix ===
%a         b        <-- class as
%175 (TP)   25 (FN)      |a = positive (200)
%81 (FP)    119 (TN)      |b = negative (200)
%========================
%Accuracy:  73.5 %
%TPR:  87.5 %
%TNR:  59.5 %
...
%=== Confusion Matrix ===
%a         b        <-- class as
%172 (TP)   28 (FN)      |a = positive (200)
%75 (FP)    125 (TN)      |b = negative (200)
%========================
%Accuracy:  74.25 %
%TPR:  86.0 %
%TNR:  62.5 %
...
%
%---------------- 10-FOLD GENERAL RESULTS ----------------
% ---> Avg Precision:  69.1478414655 %
%Standard Deviation:  0.521803685037 %
% ---> Avg Recall:  85.8 %
%Standard Deviation:  1.22882057274 %
% ---> Avg Accuracy:  73.75 %
%Standard Deviation:  0.273861278753 %
% ---> Avg F1:  76.5707887951 %
%Standard Deviation:  0.29666598806 %
%---> Avg TPR:  85.8 %
%Standard Deviation:  1.22882057274 %
%---> Avg TNR:  61.7 %
%Standard Deviation:  1.41774468788 %
%array([[ 74.  ,  73.5 ,  74.  ,  73.5 ,  73.5 ,  73.75,  74.  ,  74.25,
%         73.5 ,  73.5 ]])
